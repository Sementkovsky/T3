...
public class Runner {
    public static void main(String[] args) throws IOException {
        ...
        //Это массив, описывающий все римские цифры, допустимые для ввода (1 - 10)
        ...
        String[] words = inputStatement.split(" ");
        if (words.length != 3) {
        ...
        if (!romeMode) {                                //Проверяем, находятся ли введенные числа в заданном диапазоне
            ...
            if(!romeMode) {
                System.out.println(result);  //Выводим результат, если цифры арабские
            }
            else{
                ConvertToRoman obj3 = new ConvertToRoman();
                String resultRoman = obj3.Convert(result);  //Если числа - римские, конвертирем и выводим
